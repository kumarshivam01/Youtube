...
<div style="border: 1px solid red;height: 15px; margin-top: 16px;width: 30px;border-radius: 38%;background-color: red;color: white;font-weight: bolder; text-align: center;">3+</div>
</div>
